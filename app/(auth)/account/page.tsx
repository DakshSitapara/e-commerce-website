                    ...
                    <AlertDialogAction
                      onClick={() => {
                        if (confirmAction === "logout") handleLogout();
                          ...
                          handleDeleteAccount();
                        else if (confirmAction === "clearOrders")
                          handleClearOrders();
                        else if (confirmAction === "deleteOrder")
                          handleDeleteOrder();
                      }}
                    >
                      {confirmAction === "logout"
                ...
                <CardTitle className="flex justify-between items-center border-b border-gray-300 pb-1">
                  ...
                  {showUserInfoForm ? (
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent
                        align="center"
                        className="flex flex-row justify-between border-none shadow-none"
                      >
                        <DropdownMenuItem
                ...
                {showUserInfoForm ? (
                  <form onSubmit={subUser(onSubmitUser)} className="space-y-4">
                    <div>
                      <Label>Name</Label>
                      <Input
                        {...regUser("name", { required: "Name is required" })}
                      />
                      {errUser.name && (
