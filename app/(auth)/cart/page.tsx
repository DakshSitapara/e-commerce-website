      ...
      {cart.length === 0 ? (
        ...
        <div className="mt-16 w-full grid grid-cols-1 gap-6">
          <Card className="bg-white shadow-md rounded-lg">
            ...
            <CardFooter className="flex justify-between items-center border-t border-gray-300">
